...
#importing data
train <- read.csv("C:/Users/GnanaTeja/Desktop/IDS 532/Project/train.csv")
test <- read.csv("C:/Users/GnanaTeja/Desktop/IDS 532/Project/test.csv")
head(train)
testdata <- test[,2]
...
train$High<-as.numeric(train$High)
train$Low<-as.numeric(train$Low)
...
train <- train[, - 8] #Removing column 8 - we are removing a ( difference) 
